...
def main():
    ...
    buildcmd_slidecreater = 'msbuild "SlideCreater" -r /t:publish /p:PublishDir=".\..\publish\{0}\SlideCreater" /p:Configuration=Release /p:SelfContained=true /p:RuntimeIdentifier=win-x64 /p:PublishSingleFile=true /p:IncludeAllContentForSelfExtract=true'.format(bnumstr)
    ...
    buildcmd_integratedpresenter = 'msbuild "IntegratedPresenter" -r /t:publish /p:PublishDir=".\..\publish\{0}\IntegratedPresenter" /p:Configuration=Release /p:SelfContained=true /p:RuntimeIdentifier=win-x64 /p:PublishSingleFile=true /p:IncludeAllContentForSelfExtract=true'.format(bnumstr)
