...
namespace Integrated_Presenter.Automation
{
    internal class SlideActionAutomater : ActionAutomater, ISlideScriptActionAutomater
    {
        ...
        internal SlideActionAutomater(ILog logger,
            ...
            : base(logger, switcherProvider, autoTransitionProvider, automationConditionProvider, configProvider, featureFlagProvider, userTimerProvider, mainUIProvider, presentationProvider, audioDriverProvider, mediaDriverProvider, watchProvider, dynamicControlProvider)
        {
        }
